...
spreadsheet_id = "1jjP10bqnwHpS2g13QTAIb4P2ZOmvwL7N6j5ppGXy5hM"
            ...
            with zipfile.ZipFile(io.BytesIO(response.content)) as z:
                ...
                with z.open(csv_filename) as f:
                    ...
                    df = df[
                        ~df[sym_col]
                        .astype(str)
                        .str.contains(filter_keywords, case=False, na=False)
                    ]
...
if data_to_insert:
    ...
    try:
        ...
        print(
            f"SUCCESS: Turnover Sheet Updated Successfully "
